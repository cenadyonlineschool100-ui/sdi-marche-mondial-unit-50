    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketplace.deliveryemployee')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='Ma Boutique', max_length=100)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.AddField(
            model_name='product',
            name='shop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketplace.shop'),
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('type', models.CharField(choices=[('commission', 'Commission'), ('cashback', 'Cashback'), ('payment', 'Payment'), ('admin_credit', 'Admin Credit'), ('transfer', 'Transfer')], max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer_balance', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('seller_balance', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
